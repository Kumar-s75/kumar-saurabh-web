...
export default function Contact() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    window.location.href = `mailto:kumarsaurabh27d@gmail.com?subject=${encodeURIComponent(subject)}&body=${body}`;
  };
          ...
          <div className="space-y-6">
            ...
            <div className="pt-4">
              ...
              <div className="flex gap-3 flex-wrap">
                ...
                <Link
                  href="https://www.linkedin.com/in/kumar-saurabh786/"
